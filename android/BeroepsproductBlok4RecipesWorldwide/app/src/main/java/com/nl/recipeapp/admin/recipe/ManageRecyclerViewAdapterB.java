...
public class ManageRecyclerViewAdapterB extends RecyclerView.Adapter<com.nl.recipeapp.admin.recipe.ManageRecyclerViewAdapterB.ViewHolder> {
    private View view;
    private ArrayList<Ingredient> arraylist_ingredients_recyclerview;

    public ManageRecyclerViewAdapterB(ArrayList<Ingredient> arraylist_ingredients_recyclerview) {
        this.arraylist_ingredients_recyclerview = arraylist_ingredients_recyclerview;
    }

    @NonNull
    @Override
    public com.nl.recipeapp.admin.recipe.ManageRecyclerViewAdapterB.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        view = LayoutInflater.from(parent.getContext()).inflate(R.layout.recyclerview_listitem_ingredient, parent, false);
        com.nl.recipeapp.admin.recipe.ManageRecyclerViewAdapterB.ViewHolder viewHolder = new com.nl.recipeapp.admin.recipe.ManageRecyclerViewAdapterB.ViewHolder(view);

        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull com.nl.recipeapp.admin.recipe.ManageRecyclerViewAdapterB.ViewHolder holder, final int position) {
